                    ...
                    <div className='d-lg-flex '>
                        <div className="col-lg-7 col-12 text=center ">
                            <div className='d-lg-inline-block d-flex flex-column  align-items-center '>
                                <p data-aos="fade-left" data-aos-duration="1000">My name is Kaleeswaran, I am a Full stack developer with a great passion for programming. I am passionate about delivering solutions that add value to people's lives and at the same time challenge me. Improved my skills as a Front-End </p>
                                <p data-aos="fade-left" data-aos-duration="1300">I develop websites and applications using HTML, CSS , JavaScript , Python , Mysql and MongoDb I am familiar with developing layouts that provide me. I'm always improving myself with each project they put in my hands.</p>
                            ...
                            <div className='hard-skills my-3 d-flex justify-content-lg-start justify-content-center'>
                                <div className="html px-2" data-aos="fade-up" data-aos-duration="1000">
                                    <img src={mysql} className='img-fluid logo' alt="" />
                                </div>
                                <div className="html px-2" data-aos="fade-up" data-aos-duration="1000">
                                    <img src={dj} className='img-fluid logo' alt="" />
                                </div>
                                <div className="html px-2" data-aos="fade-up" data-aos-duration="1000">
                                    <img src={python} className='img-fluid logo' alt="" />
                                </div>
