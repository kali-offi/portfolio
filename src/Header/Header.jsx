...
import Resume from '../assets/resume-kali.pdf'
                ...
                <div className="container">
                    <div className=" d-flex justify-content-center align-items-center">
                        <div className="col-lg-7 col-12">
                            ...
                            <p className='front-end' data-aos="fade-up" data-aos-duration="1000">Fullstack Developer</p>
                            <p data-aos="fade-up" data-aos-duration="1000">I'm a Full stack developer with a focus on web development </p>
                          <a href={Resume} download='resume'>  <button className='px-5 py-2 border-0 contact' dow data-aos="fade-up" data-aos-duration="1000">Contact</button></a>
                        </div>
